...
public class ProductImagesDataAdaptersEdit extends RecyclerView.Adapter<ProductImagesDataAdaptersEdit.ViewHolder> {
    private ArrayList<ProductImages> imageUrls;
    private EditCourse context;

    public ProductImagesDataAdaptersEdit(EditCourse context, ArrayList<ProductImages> imageUrls) {
        this.context = context;
        this.imageUrls = imageUrls;
    }

    @Override
    public ProductImagesDataAdaptersEdit.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
